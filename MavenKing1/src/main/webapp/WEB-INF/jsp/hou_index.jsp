		...
		<div class="row">
			...
			<div
				...
				<div class="navbar-header col-md-2">
					<a class="navbar-brand" href="index.html"> <strong>理</strong>财
					</a>
				...
				<div class="navbar-collapse">
					...
					<ul class="nav navbar-nav side-nav" id="sidebar">
						...
						<li class="navigation" id="navigation"><a href="#"
							class="sidebar-toggle" data-toggle="#navigation">后台管理 <i
								class="fa fa-angle-up"></i></a>

							<ul class="menu">

								<li><a href="index.html"> <span class="badge badge-red">new
									</span>
								</a></li>

								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown"> <i class="fa fa-th-large"></i> <font
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown"> <i class="fa fa-pencil"></i><font
										size="3">钱包管理</font><b class="fa fa-plus dropdown-plus"></b> <span
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown"> <i class="fa fa-tint"></i> <font
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown"> <i class="fa fa-desktop"></i> <font
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown"> <i class="fa fa-play-circle"></i> <font
								...
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown"> <i class="fa fa-bar-chart-o"></i> <font
